<x-app-layout>
    ...
    <div x-data="{ updateOrCreateOpen : false, data : {}, deleteOpen : false, deleteData : {} }" class="py-12">
        ...
        <div x-show="updateOrCreateOpen" id="createOrUpdateModal" tabindex="-1" aria-hidden="true" class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
        ...
        <div x-show="deleteOpen" id="deleteModal" tabindex="-1" class="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full">
